...
TRANSACTION_ATTEMPT_LIST_STORAGE_COLLECTION_NAME = InjectionToken('TRANSACTION_ATTEMPT_LIST_STORAGE_COLLECTION_NAME',
                                                                  str)
FAILED_TRANSACTION_STORAGE_COLLECTION_NAME = InjectionToken('FAILED_TRANSACTION_STORAGE_COLLECTION_NAME', Collection)
GATEWAY_MESSAGE_STORAGE_COLLECTION_NAME = InjectionToken('GATEWAY_MESSAGE_STORAGE_COLLECTION_NAME', Collection)
...
GATEWAY_FAILED_TRANSACTION_STORAGE_COLLECTION = InjectionToken('GATEWAY_FAILED_TRANSACTION_STORAGE_COLLECTION',
                                                               Collection)
GATEWAY_MESSAGE_STORAGE_COLLECTION = InjectionToken('GATEWAY_MESSAGE_STORAGE_COLLECTION', Collection)
...
API_KEY = InjectionToken('API_KEY', str)
