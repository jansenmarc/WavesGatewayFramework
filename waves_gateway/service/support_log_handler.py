...
class SupportLogHandler(Handler):
    ...
    def _process_info(self, msg: str, log_entry: str):
        ...
        if "Created new attempt list" in log_entry:
            ...
            message = msg
        elif " is already complete" in log_entry:
            message = msg
    ...
    def _process_error(self, msg: str, log_entry: str):
        ...
        if "NewConnectionError" in log_entry:
            ...
            if ("Encountered an unknown exception while trying to perform waves transaction." in log_entry):
                message = "Encountered an unknown exception while trying to perform waves transaction."
        ...
        elif "DuplicateAttemptListTriggerError" in log_entry:
            message = "An attemptlist with this trigger already exists."

        elif "DuplicateMappingError" in log_entry:
        ...
        elif ("AutoReconnect" in log_entry) and ("pymongo" in log_entry):
